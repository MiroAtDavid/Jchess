...
// TODO three moves repeat rule, 50 moves rule
// TODO .....
...
public class Board {
    ...
    LinkedHashMap<Piece, ArrayList<Square>> recordMoves = new LinkedHashMap<>();
    ...
    public void addSquare(String squareName, int row, int col, Color color) throws BoardException {
